...
function InputValidation({ component_id, currSectionId }) {
  ...
  useEffect(() => {
    ...
    setValidationType(
      currComponent.component_prop_object.validation?.type || "Email"
    );
    setComparisonType(
      currComponent.component_prop_object.validation?.comparison || ""
    );
    ...
    <div className="form validation">
      ...
      <div className="validation-conditions">
        ...
        <div className="answer-limit">
          {comparisonType && comparisonTypes && validationType !== "Email" ? (
            <TextareaAutosize
              className="input"
