...
export const FormPage = () => {
  ...
  useEffect(() => {
    ...
    const formUrl =
      formUrlArray[formUrlArray.length - 2] +
      "/" +
      formUrlArray[formUrlArray.length - 1];
    const currUserId = localStorage.getItem("userId");
    dispatch(setInitialState(null));

    const fetchForm = () => {
      axios
        .get(`https://surveyblitz-api.onrender.com/getFormQuestions/${formUrl}`)
        .then((response) => {
  ...
  return isLoading ? (
    ...
    <div className="form-page-container" id="page">
      <div className="form-container">
        ...
        <SectionContainer currentSectionIndex={currentSectionIndex} />
